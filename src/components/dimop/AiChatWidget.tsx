  ...
  const sendMessage = useCallback(
    async (text: string) => {
      ...
      try {
        ...
        setMessages((prev) => [
          ...prev,
          { role: 'assistant', content: data.reply || 'Sajnos hiba történt. Próbálja újra!' },
        ]);
      } catch {
        setMessages((prev) => [
          ...prev,
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between gap-3 bg-gray-950 px-4 py-3 text-white">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-[10px] text-white/40 leading-tight">DIMOP Pályázati Asszisztens</div>
              </div>
            </div>
            <button
              type="button"
      ...
      <button
        ...
        aria-label={open ? 'Chat bezárása' : 'AI Chat megnyitása'}
      >
        {open ? (
