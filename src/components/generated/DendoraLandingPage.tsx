...
export const DendoraLandingPage: React.FC = () => {
  ...
  const navItems = [{
    id: 'home',
    label: 'Home',
    mpid: "6eea04a4-72fc-45b2-a150-1ff8acf71e18"
  }, {
    id: 'services',
    label: 'Services',
    mpid: "d6dbc2d1-ada2-49ac-aea1-f5233ac02aa2"
  }, {
    id: 'work',
    label: 'Work',
    mpid: "8ef48929-a608-4adf-a053-74f4b831a317"
  }, {
    id: 'about',
    label: 'About',
    mpid: "0bce539e-8cd0-43b5-ab9b-4e265effa734"
  }, {
    id: 'contact',
    label: 'Contact',
    mpid: "cc9e073a-d20a-4da1-a138-9f92840a0607"
  }] as const;
  const Feature: React.FC<{
    ...
    title,
    desc
  }) => <SortableContainer dndKitId="07ce2e63-5a8a-4555-bf08-4925ec29a09a" containerType="regular" prevTag="div" className="group relative rounded-xl border border-black/5 bg-white p-6 shadow-sm transition hover:shadow-md" data-magicpath-id="0" data-magicpath-path="DendoraLandingPage.tsx">
      <SortableContainer dndKitId="33b8a7db-b4f1-4f06-8db9-a5066fb20b1f" containerType="regular" prevTag="div" className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-full bg-black text-white" data-magicpath-id="1" data-magicpath-path="DendoraLandingPage.tsx">
  ...
  const Stat: React.FC<{
    ...
    value,
    label
  }) => <SortableContainer dndKitId="ca8ecad0-d764-40ff-add2-8de96eba8723" containerType="regular" prevTag="div" className="flex flex-col items-start" data-magicpath-id="6" data-magicpath-path="DendoraLandingPage.tsx">
  ...
  // @return
  return <SortableContainer dndKitId="f98e4347-fd26-4aef-b677-d550870ba1ed" containerType="regular" prevTag="div" className="min-h-dvh w-full bg-white text-black antialiased" data-magicpath-id="11" data-magicpath-path="DendoraLandingPage.tsx">
      {/* Header */}
      <SortableContainer dndKitId="3f54814d-0f1b-4ee0-9b57-2044a430e6ca" containerType="regular" prevTag="header" className="sticky top-0 z-40 w-full border-b border-black/5 bg-white/70 backdrop-blur" data-magicpath-id="12" data-magicpath-path="DendoraLandingPage.tsx">
        <SortableContainer dndKitId="09de8ee5-6991-4592-a5cc-bdabd3923586" containerType="regular" prevTag="div" className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4" data-magicpath-id="13" data-magicpath-path="DendoraLandingPage.tsx">
          <SortableContainer dndKitId="2ae10825-7681-45fa-b81d-261f47b03032" containerType="regular" prevTag="button" onClick={() => scrollTo('home')} className="group flex items-center gap-3" aria-label="Dendora home" data-magicpath-id="14" data-magicpath-path="DendoraLandingPage.tsx">
            {/* Logo */}
            <SortableContainer dndKitId="8767fa6e-41b9-4744-aa1a-e9d34bf7dfd2" containerType="regular" prevTag="div" className="relative h-8 w-8" data-magicpath-id="15" data-magicpath-path="DendoraLandingPage.tsx">
            ...
            <SortableContainer dndKitId="f967fbce-6fb9-42db-b35f-f999c9e2687d" containerType="regular" prevTag="div" className="flex flex-col items-start text-left" data-magicpath-id="19" data-magicpath-path="DendoraLandingPage.tsx">
          ...
          {/* Desktop nav */}
          <SortableContainer dndKitId="e87a2b83-6ef5-4c87-b53e-5258cd149214" containerType="collection" prevTag="nav" className="hidden items-center gap-6 md:flex" data-magicpath-id="22" data-magicpath-path="DendoraLandingPage.tsx">
          ...
          {/* Mobile menu button */}
          <SortableContainer dndKitId="0529cffd-8f2e-48b2-8102-a0e40ef10b8b" containerType="regular" prevTag="button" className="inline-flex items-center justify-center rounded-md p-2 hover:bg-black/5 md:hidden" aria-label="Toggle menu" aria-expanded={menuOpen} onClick={() => setMenuOpen(v => !v)} data-magicpath-id="28" data-magicpath-path="DendoraLandingPage.tsx">
        ...
        {/* Mobile nav */}
        {menuOpen && <SortableContainer dndKitId="16db8134-ff9a-4885-912d-365a2699fd0e" containerType="regular" prevTag="div" className="border-t border-black/5 bg-white md:hidden" data-magicpath-id="31" data-magicpath-path="DendoraLandingPage.tsx">
            <SortableContainer dndKitId="2ef608a6-de77-45d3-814b-6d511d7e0a76" containerType="regular" prevTag="nav" className="mx-auto max-w-6xl px-4 py-2" data-magicpath-id="32" data-magicpath-path="DendoraLandingPage.tsx">
              <SortableContainer dndKitId="74cb114d-02f6-4c2a-bdd5-4558a9fdb6a2" containerType="collection" prevTag="div" className="grid gap-1" data-magicpath-id="33" data-magicpath-path="DendoraLandingPage.tsx">
      ...
      {/* Hero */}
      <SortableContainer dndKitId="5a6296f9-298e-40da-ae9d-4c4ab2c64efa" containerType="regular" prevTag="section" id="home" className="relative" data-magicpath-id="39" data-magicpath-path="DendoraLandingPage.tsx">
        ...
        <SortableContainer dndKitId="39cfb65b-5193-4d30-9a05-198640f2b489" containerType="regular" prevTag="div" className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-4 py-16 md:grid-cols-2 md:py-24" data-magicpath-id="41" data-magicpath-path="DendoraLandingPage.tsx">
          <SortableContainer dndKitId="5efcb7cb-d32c-44e0-9271-0bc398594875" containerType="regular" prevTag="div" className="flex flex-col justify-center" data-magicpath-id="42" data-magicpath-path="DendoraLandingPage.tsx">
            ...
            <SortableContainer dndKitId="95d92032-8ee9-4511-b7ff-210efdc103d5" containerType="regular" prevTag="div" className="mt-8 flex flex-wrap items-center gap-3" data-magicpath-id="47" data-magicpath-path="DendoraLandingPage.tsx">
            ...
            <SortableContainer dndKitId="834a731a-5ea1-4404-a217-da496a48fa83" containerType="regular" prevTag="div" className="mt-10 grid grid-cols-3 gap-6 md:max-w-md" data-magicpath-id="53" data-magicpath-path="DendoraLandingPage.tsx">
          ...
          <SortableContainer dndKitId="03aa3e1a-6cc6-41a1-b3f5-1befe7859aef" containerType="regular" prevTag="div" className="flex items-center justify-center" data-magicpath-id="56" data-magicpath-path="DendoraLandingPage.tsx">
            {/* Brand card */}
            <SortableContainer dndKitId="4bd56fd4-1af7-4475-8789-dde2a9badb62" containerType="regular" prevTag="motion.div" initial={prefersReducedMotion ? undefined : {
            opacity: 0,
            scale: 0.98
          }} whileInView={prefersReducedMotion ? undefined : {
            opacity: 1,
            ...
            delay: 0.1
              ...
              <SortableContainer dndKitId="d2614796-0aa6-45e9-b7fb-503b1b675aa8" containerType="regular" prevTag="div" className="flex items-center gap-4" data-magicpath-id="58" data-magicpath-path="DendoraLandingPage.tsx">
                <SortableContainer dndKitId="e1814545-c21b-41f8-a758-ffbd9c14f2e3" containerType="regular" prevTag="div" className="relative h-14 w-14" data-magicpath-id="59" data-magicpath-path="DendoraLandingPage.tsx">
                ...
                <SortableContainer dndKitId="55a5ae83-65d1-49b6-a08f-ac807346ecfb" containerType="regular" prevTag="div" data-magicpath-id="63" data-magicpath-path="DendoraLandingPage.tsx">
              ...
              <SortableContainer dndKitId="52658839-f062-4fb3-8503-8b2d916dd3c9" containerType="regular" prevTag="div" className="mt-6 rounded-xl border border-black/10 bg-gradient-to-br from-black/[0.02] to-transparent p-4" data-magicpath-id="66" data-magicpath-path="DendoraLandingPage.tsx">
      ...
      {/* Services */}
      <SortableContainer dndKitId="7c4158ff-0077-4801-acec-b70ac81b96d4" containerType="regular" prevTag="section" id="services" className="border-t border-black/5 bg-white" data-magicpath-id="69" data-magicpath-path="DendoraLandingPage.tsx">
        <SortableContainer dndKitId="23975fca-0969-453f-b8b6-334ecf279965" containerType="regular" prevTag="div" className="mx-auto max-w-6xl px-4 py-16 md:py-20" data-magicpath-id="70" data-magicpath-path="DendoraLandingPage.tsx">
          <SortableContainer dndKitId="fe0fc5bc-c4ce-4a89-9685-c8b7300d8f7e" containerType="regular" prevTag="div" className="mb-8 flex items-end justify-between" data-magicpath-id="71" data-magicpath-path="DendoraLandingPage.tsx">
          ...
          <SortableContainer dndKitId="bd82c73a-a295-4ba3-ad5e-5f878640395f" containerType="regular" prevTag="div" className="grid gap-4 md:grid-cols-3" data-magicpath-id="74" data-magicpath-path="DendoraLandingPage.tsx">
      ...
      {/* Work */}
      <SortableContainer dndKitId="e93322f7-a170-4dd3-8d12-a710833332a8" containerType="regular" prevTag="section" id="work" className="border-t border-black/5" data-magicpath-id="78" data-magicpath-path="DendoraLandingPage.tsx">
        <SortableContainer dndKitId="07f4c10a-affc-4797-a5c2-c520dd90be8e" containerType="regular" prevTag="div" className="mx-auto max-w-6xl px-4 py-16 md:py-20" data-magicpath-id="79" data-magicpath-path="DendoraLandingPage.tsx">
          <SortableContainer dndKitId="f7ebe2d0-1b9d-46d8-b315-ccf53fdf1422" containerType="regular" prevTag="div" className="mb-8 flex items-end justify-between" data-magicpath-id="80" data-magicpath-path="DendoraLandingPage.tsx">
          ...
          <SortableContainer dndKitId="633cca56-92aa-4357-b3aa-74822fd26a0d" containerType="collection" prevTag="div" className="grid gap-6 md:grid-cols-3" data-magicpath-id="83" data-magicpath-path="DendoraLandingPage.tsx">
            {[{
            name: 'FoundryPulse',
            desc: 'Automating corporate workflows with robust orchestration and clear oversight.',
            brandBg: 'bg-[#0B0D10]',
            image: {
              src: '/foundrypulse-logo.png',
              alt: 'FoundryPulse logo with stylized mark'
            },
            mpid: "88eb7d4c-e33c-4b58-b6c5-a825fcb00f42"
          }, {
            name: 'SaaS Dashboard',
            ...
            image: undefined,
            mpid: "1e803de5-31a0-4027-9585-e38c5b72e9c4"
          }, {
            name: 'E‑commerce Revamp',
            desc: 'Headless storefront with lightning‑fast navigation and checkout.',
            brandBg: 'bg-[linear-gradient(120deg,rgba(0,0,0,0.06),transparent)]',
            image: undefined,
            mpid: "8c0e2290-9094-4404-9d95-02b431a444ec"
      ...
      {/* About */}
      <SortableContainer dndKitId="b283793f-cb06-4f3c-8712-b54af21d9e06" containerType="regular" prevTag="section" id="about" className="border-t border-black/5 bg-white" data-magicpath-id="106" data-magicpath-path="DendoraLandingPage.tsx">
        <SortableContainer dndKitId="6f007bbf-28d9-41d1-b9ea-977144dd13c0" containerType="regular" prevTag="div" className="mx-auto max-w-6xl px-4 py-16 md:py-20" data-magicpath-id="107" data-magicpath-path="DendoraLandingPage.tsx">
          <SortableContainer dndKitId="ec7b816c-61db-48cf-b6d0-bda52313b4ff" containerType="regular" prevTag="div" className="grid items-center gap-10 md:grid-cols-2" data-magicpath-id="108" data-magicpath-path="DendoraLandingPage.tsx">
            <SortableContainer dndKitId="d65af337-5931-4a04-8283-1211d212a79c" containerType="regular" prevTag="div" data-magicpath-id="109" data-magicpath-path="DendoraLandingPage.tsx">
              ...
              <SortableContainer dndKitId="fd1d3bf3-5dc4-463e-8950-d150fb59cb00" containerType="regular" prevTag="ul" className="mt-6 grid gap-2 text-sm text-black/70" data-magicpath-id="113" data-magicpath-path="DendoraLandingPage.tsx">
              ...
              <SortableContainer dndKitId="b97839e5-342b-4982-9706-041b12b397ae" containerType="regular" prevTag="div" className="mt-7 flex gap-3" data-magicpath-id="123" data-magicpath-path="DendoraLandingPage.tsx">
            ...
            <SortableContainer dndKitId="8a1acb5a-feb5-4bf6-807d-b6eaf2fda124" containerType="regular" prevTag="div" className="relative" data-magicpath-id="129" data-magicpath-path="DendoraLandingPage.tsx">
              ...
              <SortableContainer dndKitId="d3563893-e298-43c4-9543-32b25d11b39d" containerType="regular" prevTag="div" className="overflow-hidden rounded-2xl border border-black/10 bg-white p-6" data-magicpath-id="131" data-magicpath-path="DendoraLandingPage.tsx">
                <SortableContainer dndKitId="51332590-706c-4b2f-95e3-315a45e62e1e" containerType="regular" prevTag="div" className="grid gap-4 md:grid-cols-2" data-magicpath-id="132" data-magicpath-path="DendoraLandingPage.tsx">
                  <SortableContainer dndKitId="d21cfd92-e5dd-4c57-83ac-174eb6c3a8f9" containerType="regular" prevTag="div" className="rounded-xl border border-black/10 p-4" data-magicpath-id="133" data-magicpath-path="DendoraLandingPage.tsx">
                  ...
                  <SortableContainer dndKitId="93a5bf3c-0432-4071-a761-5ab1f899ab61" containerType="regular" prevTag="div" className="rounded-xl border border-black/10 p-4" data-magicpath-id="137" data-magicpath-path="DendoraLandingPage.tsx">
                  ...
                  <SortableContainer dndKitId="4f507863-f007-4d7b-b5d5-afe27f59cdfe" containerType="regular" prevTag="div" className="rounded-xl border border-black/10 p-4" data-magicpath-id="141" data-magicpath-path="DendoraLandingPage.tsx">
                  ...
                  <SortableContainer dndKitId="3f9fff23-e9f0-4303-8e12-dafec1c6c867" containerType="regular" prevTag="div" className="rounded-xl border border-black/10 p-4" data-magicpath-id="145" data-magicpath-path="DendoraLandingPage.tsx">
      ...
      {/* Contact */}
      <SortableContainer dndKitId="a618b959-dcd2-4679-8ef1-795db24aa682" containerType="regular" prevTag="section" id="contact" className="border-t border-black/5" data-magicpath-id="149" data-magicpath-path="DendoraLandingPage.tsx">
        <SortableContainer dndKitId="6c0c49fd-139f-4f99-9e60-81f60d30c883" containerType="regular" prevTag="div" className="mx-auto max-w-6xl px-4 py-16 md:py-20" data-magicpath-id="150" data-magicpath-path="DendoraLandingPage.tsx">
          <SortableContainer dndKitId="58709afa-6866-43d5-879a-f2341b90cbe0" containerType="regular" prevTag="div" className="mx-auto max-w-3xl rounded-2xl border border-black/10 bg-white p-6 md:p-8" data-magicpath-id="151" data-magicpath-path="DendoraLandingPage.tsx">
            ...
            <SortableContainer dndKitId="71d61e2e-32a0-472f-9fc0-e62b215c951f" containerType="regular" prevTag="div" className="mt-6 flex flex-wrap items-center gap-3" data-magicpath-id="155" data-magicpath-path="DendoraLandingPage.tsx">
      ...
      {/* Footer */}
      <SortableContainer dndKitId="51b721f0-593f-4f10-87d6-00fcfeb46eb5" containerType="regular" prevTag="footer" className="border-t border-black/5" data-magicpath-id="165" data-magicpath-path="DendoraLandingPage.tsx">
        <SortableContainer dndKitId="553955e2-1c10-484c-ba03-308d0e1cc896" containerType="regular" prevTag="div" className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-8 text-sm text-black/60 md:flex-row" data-magicpath-id="166" data-magicpath-path="DendoraLandingPage.tsx">
          <SortableContainer dndKitId="e1b1ed1e-5043-42ca-81fd-7d3f1e48b2e0" containerType="regular" prevTag="div" className="flex items-center gap-3" data-magicpath-id="167" data-magicpath-path="DendoraLandingPage.tsx">
            <SortableContainer dndKitId="86f3dfe5-b5a5-464c-8830-225249a9b038" containerType="regular" prevTag="div" className="relative h-7 w-7" data-magicpath-id="168" data-magicpath-path="DendoraLandingPage.tsx">
          ...
          <SortableContainer dndKitId="f6cc09f7-bcb2-41f9-bf2b-0093ff8aaff1" containerType="regular" prevTag="div" className="flex items-center gap-4" data-magicpath-id="173" data-magicpath-path="DendoraLandingPage.tsx">
